 ...
 * <li>Enable NDK support in {@code app/build.gradle}:
 *   <pre>
 * android {
 *     ...
 *     externalNativeBuild {
 ...
 * }
 *   </pre>
 * <li>Create symlinks to the Java and C library source:
 *   <pre>
 ...
 *   </pre>
 * <li>Create {@code app/src/main/cpp/CMakeLists.txt}:
 *   <pre>
 ...
 *   </pre>
 * <li>In your Activity, load the native library and create an encoder instance:
 *   <pre>
