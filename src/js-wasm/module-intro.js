 ...
 * @module gs1encoder
 * @description
 * GS1 Barcode Syntax Engine - JavaScript wrapper.
 * <p>
 ...
 * <p>
 * <strong>Note:</strong> Using the library always begins by creating a new GS1encoder instance
 * and calling {@link GS1encoder#init}.
 * <p>
 * <strong>Note:</strong> Unless otherwise specified, the getter methods return library-managed
 ...
 * <p>
 * <strong>Note:</strong> Most of the setter and action methods of this library throw exceptions
 ...
 *
 * const hri = gs.getHRI();                                 // Display the extracted AI data as HRI text
 ...
 * reader.
 * <p>
 * <strong>Note:</strong> It is assumed the scanned barcode message "survives the channel" intact,
